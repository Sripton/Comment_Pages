...
function editComment(button) {
  const commentTextElement = button
    .closest(".comment")
...
function toggleActions(dotsElement) {
  const commentElement = dotsElement.closest(".comment");
  commentElement.classList.toggle("show-actions");
}

// Функция для скрытия кнопок
function closeActions(closeElement) {
  const commentElement = closeElement.closest(".comment");
  commentElement.classList.remove("show-actions");
}
